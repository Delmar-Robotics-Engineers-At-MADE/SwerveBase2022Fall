...
public class SetSwerveDriveSlow extends CommandBase {
  ...
  private final DriveSubsystem m_swerveDriveSlow;
  ...
  public SetSwerveDriveSlow(
    ...
    m_swerveDriveSlow = swerveDriveSubsystem;
  ...
  public void execute() {
    ...
    m_swerveDriveSlow.drive(throttle_sl, strafe_sl, rotation_sl, true);
    //System.out.println("********************* throttle: " + throttle_sl);
